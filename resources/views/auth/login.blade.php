      ...
      <div class="row justify-content-center">
        <div class="col-md-8">
          <div class="card-group">
            ...
            <div class="card text-white bg py-5 d-md-down-none" style="width:44%; bg-color:#3c4b6424;">
              <div class="card-body text-center">
                <div>
                    <img src="{{asset('assets/img/covid.png')}}" style="width:300px; height:300px;" alt="">
                </div>
              </div>
            </div>
          </div>
