...
class KelurahanController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $kelurahan->save();
        return redirect()->route('kelurahan.index')->with(['success'=>'Data Berhasil Di Input!']);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $kelurahan->nama_kelurahan = $request->nama_kelurahan;
        $kelurahan->save();
        return redirect()->route('kelurahan.index')->with(['info'=>'Data Berhasil Di Edit!']);
    }
    ...
    public function destroy($id)
    {
        $kelurahan = Kelurahan::findOrFail($id);
        $kelurahan->delete();
        return redirect()->route('kelurahan.index')->with(['error'=>'Data Berhasil Di Hapus!']);
    }
}
